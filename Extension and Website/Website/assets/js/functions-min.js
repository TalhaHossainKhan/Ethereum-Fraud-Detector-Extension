    ...
    function s() {
      ...
      function moveToNextSlide() {
          $(".slider").animate({ opacity: 0 }, 400, function() {
              ...
              items.eq((currentIndex + 1) % totalItems).addClass('slider--item-center');
              items.eq((currentIndex + 2) % totalItems).addClass('slider--item-right');
              $(".slider").animate({ opacity: 1 }, 400);
              currentIndex = (currentIndex + 1) % totalItems;
          });
      }
  
      // Trigger a click event on the next button to show the initial slide only once
      moveToNextSlide();
  
      // Click event for sliding
      $(".slider--prev, .slider--next").click(moveToNextSlide);
  }
